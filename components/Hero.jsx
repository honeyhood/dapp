        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset={1} stopColor="#AFB4FF" />
            </linearGradient>
          </defs>
        </svg>
      </div>
          ...
          <nav className="flex h-9 items-center justify-between" aria-label="Global">
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <h1 className="text-2xl font-bold text-black">WIRED</h1>
              </a>
            </div>
            ...
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              ...
              <div>
                <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl text-black">
                  Get connected to web3 from one place 
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
                  Swap tokens, deposit into liquidity pools, lend and borrow, get market insights, see your portfolio, discuss with the community and more.
                </p>
